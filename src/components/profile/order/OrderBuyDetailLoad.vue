<template>
  <div>
    <div>
      ...
      <br><br>
      <div>
        <label class="second-head">货主信息：</label>
        <hr>
        <br>
        <div class="row">
          <div class="col-md-8">货主：</div>
          <div class="col-md-4">{{''==worder.sellerInfoValue[0]? '待确定': worder.sellerInfoValue[0]}}</div>
        </div>
        <div class="row">
          <div class="col-md-8">联系人：</div>
          <div class="col-md-4">{{''==worder.sellerInfoValue[1]? '待确定': worder.sellerInfoValue[1]}}</div>
        </div>
        <div class="row">
          <div class="col-md-8">联系电话：</div>
          <div class="col-md-4">{{''==worder.sellerInfoValue[2]? '待确定': worder.sellerInfoValue[2]}}</div>
        </div>
        <div class="row">
          <div class="col-md-8">发货地址：</div>
          <div class="col-md-4">{{''==worder.sellerInfoValue[3]? '待确定': worder.sellerInfoValue[3]}}</div>
        </div>
      </div>
    </div>
  </div>
