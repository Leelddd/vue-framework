      ...
      <div>
        ...
        <div>
          <div class="row">
            ...
            <div class="col-md-4">订单状态：<span style="color: #ff0000">{{worder.buyerOrderStatusName}}</span></div>
          </div>
          <div class="row">
            <div class="col-md-8">商家名称：{{worder.sellerInfoValue[0]}}</div>
        ...
        <div>
          ...
          <div class="row">
            <div class="col-md-8">优惠：</div>
            <div class="col-md-4">{{worder.amountInfoValue[1]}}</div>
          </div>
          <div class="row">
            <div class="col-md-8">手续费：</div>
            <div class="col-md-4">{{worder.amountInfoValue[2]}}</div>
          </div>
          <div class="row">
            <div class="col-md-8">定金：</div>
            <div class="col-md-4">{{worder.amountInfoValue[3]}}</div>
          </div>
          <div class="row">
            <div class="col-md-8">定金支付方式：</div>
            <div class="col-md-4">线上支付</div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-8">尾款支付方式：</div>
            <!-- 接口中没有，待改进 -->
            <div class="col-md-4">待确定</div>
          </div>
          <div class="row">
